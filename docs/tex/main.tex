...
This distinction is not cosmetic. On the European air$+$land network, modelling
commuting as recurrent rather than diffusive lowers the peak active infection
by roughly $5\times$ (from $\sim$277\,M to $\sim$49\,M), because recurrent
commuting couples neighbours without permanently transporting the seed
population across the continent --- exactly the threshold-shifting effect
reported by~\cite{balcan:recurrent}.
